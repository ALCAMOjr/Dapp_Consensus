...
import { idlFactory } from './proyect_app_backend.did.js';
export { idlFactory } from './proyect_app_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PROYECT_APP_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./proyect_app_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the proyect_app_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./proyect_app_backend.did.js")._SERVICE>}
 */
export const proyect_app_backend = createActor(canisterId);
